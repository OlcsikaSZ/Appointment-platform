...
class BookingNotificationMail extends Mailable
{
    ...
    public function eventLabel(): string
    {
        ...
        return match ($this->eventType) {
            ...
            'booking_cancelled' => 'Foglalás lemondva',
            'booking_reminder_24h' => 'Emlékeztető a holnapi időpontról',
            'booking_reminder_2h' => 'Hamarosan kezdődik az időpontod',
            default => 'Foglalási értesítés',
        };
    }
    ...
    private function fallbackSubject(): string
    {
        return match ($this->eventType) {
            ...
            'booking_reminder_24h' => 'Emlékeztető: holnap várunk – {business_name}',
            'booking_reminder_2h' => 'Emlékeztető: hamarosan várunk – {business_name}',

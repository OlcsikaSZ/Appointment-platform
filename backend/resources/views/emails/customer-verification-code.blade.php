<!doctype html>
<html lang="hu">
<head><meta charset="utf-8"><title>Ellenőrző kód</title></head>
...
<div style="max-width:560px;margin:32px auto;background:#fff;padding:32px;border-radius:16px">
    ...
    <h1 style="font-size:24px">{{ $purpose === 'registration' ? 'Erősítsd meg a regisztrációdat' : 'Állíts be új jelszót' }}</h1>
    ...
    <p>A kód {{ $validMinutes }} percig érvényes. Ha nem te kérted, nincs további teendőd.</p>
</div>
</body>
</html>
